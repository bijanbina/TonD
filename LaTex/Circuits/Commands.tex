...
\newcommand{\nwTondCommentH}[2]{\draw [Stealth-] (#1) ++ (-\AnSpace, 0) -- ++(0,+\AnSize) -- ++(-\AnSize,0)  node [anchor=east] {#2}};
\newcommand{\seTondCommentH}[2]{\draw [Stealth-] (#1) ++ (+\AnSpace, 0) -- ++(0,-\AnSize) -- ++(+\AnSize,0)  node [anchor=west] {#2}};
\newcommand{\swTondCommentH}[2]{\draw [Stealth-] (#1) ++ (-\AnSpace, 0) -- ++(0,-\AnSize) -- ++(-\AnSize,0)  node [anchor=east] {#2}};
